...
export declare type ImgixUrlParams = Partial<Record<keyof ImgixUrlParametersSpec['parameters'] | keyof ImgixUrlParametersSpec['aliases'], string | number | boolean | undefined>>;
